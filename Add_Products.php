...
<body>
    <div class="main-div">
            <img src="images/2595829.jpg" name='back' alt="background" style="height:100%;width:100%" />
        <div class="box">
...
{ 
 $folder="images/";
  ...
  $sql1=" INSERT INTO `products` (`product_id`, `product_name`, `brand_id`, `mrp`,`discount`,`qty`,`description`,`category`,`image`) VALUES('','$product_name','$atc','$mrp','$discount','$qty','$description','$category','$P_Img')";
