...
<body>
    <div class="main-div">
            <img src="images/most-beautiful-flowers-04.jpg" name='back' alt="background" style="height:100%;width:100%" />
        <div class="box">
...
{ 
  ...
  $sql1=" UPDATE `services` SET `type`='$service_name', `sname`='$provider', `contact`='$contact',`saddress`='$address',`semail`='$email',`price`='$price',`sdiscount`='$discount' WHERE service_id='$id'";
